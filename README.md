...
- [x] Explore Gradient Boosted Classifier model for fraud detection
- [x] Explore XGBoost Classifier model for fraud detection
...
- [ ] Explore deep learning for credit card fraud classification
